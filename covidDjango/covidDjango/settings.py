...
SECRET_KEY = 'wz585u7#v%z9el)7-0^#o0d8by2*2smhap5h%#l*-@w^x$gk@3'
...
INSTALLED_APPS = [
    ...
    'question_type.apps.QuestionTypeConfig',
    ...
    'user_authority.apps.UserAuthorityConfig',
    'users.apps.UsersConfig',
    'useruvg.apps.UseruvgConfig'
]
