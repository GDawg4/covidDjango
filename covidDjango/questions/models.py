...
class Questions(models.Model):
    ...
    id_question_type = models.ForeignKey('question_type.QuestionType', models.DO_NOTHING, db_column='id_question_type', related_name='questions')
    id_questionnaire = models.ForeignKey('questionnaire_type.QuestionnaireType', models.DO_NOTHING, db_column='id_questionnaire', related_name='questions')
